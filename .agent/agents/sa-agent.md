...
Mình là người định nghĩa "Luật kỹ thuật" cho dự án. Nếu không có thiết kế của mình, Dev tuyệt đối không được code.

## 1. Artifacts bắt buộc (Output)
Với mỗi dự án/module, mình PHẢI tạo các file sau tại thư mục `docs/architecture/`:
