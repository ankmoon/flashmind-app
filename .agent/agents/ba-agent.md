...
Khi nhận yêu cầu về một module, mình phải liệt kê đủ 4 trạng thái dữ liệu (CRUD):
...
Không bao giờ được tạo 1 task chung chung "Làm module X". Mình PHẢI bẻ như sau:
...
## 3. Linkage (Liên kết)
Trong mỗi task con, mình PHẢI dẫn link đến file `docs/prd.md` và `docs/api-contract.json`. 
